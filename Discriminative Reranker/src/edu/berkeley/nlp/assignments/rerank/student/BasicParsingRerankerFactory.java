...
public class BasicParsingRerankerFactory implements ParsingRerankerFactory {
	  ...
	  public ParsingReranker trainParserReranker(Iterable<Pair<KbestList,
			  Tree<String>>> kbestListsAndGoldTrees) {
		  
		  System.out.println("BASIC: SVM");
		  return new CopyOfAwesomeParsingReranker(kbestListsAndGoldTrees);
	  }
}
