 ...
 * that path.
 */
public class UnaryClosureCustom
{
...
//	}
	...
	public UnaryClosureCustom(Indexer<String> stateIndexer, Collection<UnaryRule> unaryRules) {
	  ...
	  for (int i = 0; i < stateIndexer.size(); i++) {
		...
		Map<UnaryRule, List<Integer>> closureMap = computeUnaryClosure(unaryRules, stateIndexer);
	...
	private static Map<UnaryRule, List<Integer>> computeUnaryClosure(Collection<UnaryRule> unaryRules, Indexer<String> stateIndexer) {
